...
srun python -m torch.distributed.launch --nproc_per_node=1 \
    ...
    train_datasets=["/scratch/sebel/dpr-stat/insee_ref_dpr/train.json", "/scratch/sebel/dpr-stat/QA-fr/train.json"] \
    dev_datasets=["/scratch/sebel/dpr-stat/insee_ref_dpr/dev.json", "/scratch/sebel/dpr-stat/QA-fr/dev.json"] \
    train=biencoder_local \
    output_dir="/scratch/sebel/dpr-stat/dpr-ckpt-multi/" \
    encoder=camembert
